...
int main(int argc, char * argv[])
{
    ...
    j = fscanf(PriorFile, "%d", &n);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%d", &niter);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%d", &nsavecoda);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%d", &nvariables);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%d", &nbeta);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%d", &nbetagroup);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%d", &ntheta);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%lf", &mnb);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%lf", &varb);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%lf", &maxsdb);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%d", &fixed);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%lf", &vart);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%lf", &propsdb);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%lf", &propsdt);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%lf", &mnpsi);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%lf", &shvarp);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%lf", &rtvarp);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%lf", &propsdp);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%lf", &propsdvarp);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%d", &npsi);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%d", &RE);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%d", &movetype);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%d", &varselect);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%d", &maxinteraction);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%d", &runtraining);
    j = fscanf(PriorFile, "%s", dummy);
    j = fscanf(PriorFile, "%d", &nitertrain);
    j = fscanf(PriorFile, "%s", dummy);
    fclose(PriorFile);
    ...
    k = 0;
    for(j = 0; j < nbeta; j++) {
        posterior[index2(kcoda, j, nsavecoda)] = beta[j];
    }
    k = nbeta;
    for(j = 0; j < ntheta; j++) {
        posterior[index2(kcoda, j + k, nsavecoda)] = theta[j];
    }
    k += ntheta;
    for(j = 0; j < nbetagroup; j++) {
        posterior[index2(kcoda, j + k, nsavecoda)] = betastatus[j];
    }
    k += nbetagroup;
    for(j = 0; j < npsi; j++) {
        posterior[index2(kcoda, j + k, nsavecoda)] = psi[j];
    }
    k += npsi;
    if(fixed == 0)
    {
        for(j = 0; j < nbeta; j++) {
            posterior[index2(kcoda, j + k, nsavecoda)] = sdb[j];
        }
        k += nbeta;
    }
